...
@Component({
  selector: 'app-cebasic-details',
  templateUrl: './cebasic-details.component.html',
  styleUrls: ['./cebasic-details.component.scss']
})
export class CEbasicDetailsComponent implements OnInit {
